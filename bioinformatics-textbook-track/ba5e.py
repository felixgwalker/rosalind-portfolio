...
# Return: the score and a global alignment using BLOSUM62, linear gap penalty -5.

import os, sys

def get_input():
    p = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'rosalind-inputs', 'bioinformatics-textbook-track', 'rosalind_ba5e.txt')
    if os.path.exists(p):
